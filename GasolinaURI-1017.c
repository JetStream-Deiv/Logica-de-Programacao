...
int main()
{
    ...
    return 0;
// (URI-1017) Joaozinho quer calcular e mostrar a quantidade de litros de combustível gastos em uma viagem,
...
// Entrada: O arquivo de entrada contém dois inteiros. 
